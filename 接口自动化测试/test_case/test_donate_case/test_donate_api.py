...
class TestDonateApi:
    ...
    def test_school_permission_groups(self, desc, value):
        ...
        if res:
            assert isinstance(res, dict), f'接口返回类型异常: {type(res)}'
            assert res['code'] == 100126, f"接口返回状态码异常: 预期【401】，实际【{res['code']}】"
            assert res['message'] == 'Transaction ID already exists', f"接口返回message信息异常: 预期【unauthorized】，实际【{res['message']}】"
    ...
    #     ]
    # )
    # def test_donate_format_createdonateorder_donorType(self, desc, value, code):
    ...
    #     [
    #         ('最短长度', ""),
    #         ('最长长度', ""),
    #     ]
    # )
    ...
    def test_donate_permission_webhook(self, desc, value):
        ...
        # 鉴权作为位置参数直接传入（示例期望的极简风格）
        requestBodyString = 'hello'
        res = self.donate.webhook(authorization=value, requestBodyString=requestBodyString)
        assert isinstance(res, dict), f'接口返回类型异常: {type(res)}'
        assert res['code'] == 200
        assert res['message'] == 'success'
        assert res['data']['data']
    ...
    def test_donate_permission_donateorderstatus_details(self, desc, value):
        """查询捐赠订单状态-权限测试"""
        # 鉴权作为位置参数直接传入（示例期望的极简风格）
        res = self.donate.donateorderstatus_details(value)
        if res:
            assert isinstance(res, dict), f'接口返回类型异常: {type(res)}'
            assert res['code'] == 100121, f"接口返回状态码异常: 预期【200】，实际【{res['code']}】"
            # assert res['message'] == 'success', f"接口返回message信息异常: 预期【success】，实际【{res['message']}】"
    ...
    def test_donate_permission_getOrders(self, desc, value):
        """分页获取捐赠订单列表-权限测试"""
        # 鉴权作为位置参数直接传入（示例期望的极简风格）
        res = self.donate.getOrders(value)
        if res:
            assert isinstance(res, dict), f'接口返回类型异常: {type(res)}'
            assert res['code'] == 200, f"接口返回状态码异常: 预期【200】，实际【{res['code']}】"
            assert res['message'] == 'success', f"接口返回message信息异常: 预期【success】，实际【{res['message']}】"
    ...
    def test_donate_permission_getList(self, desc, value):
        """分页查询支出记录列表-权限测试"""
        # 鉴权作为位置参数直接传入（示例期望的极简风格）
        res = self.donate.getList(value, code=200)
        if res:
            assert isinstance(res, dict), f'接口返回类型异常: {type(res)}'
            assert res['code'] == 200, f"接口返回状态码异常: 预期【401】，实际【{res['code']}】"
            assert res['message'] == 'success', f"接口返回message信息异常: 预期【unauthorized】，实际【success】"
            assert res['data'], f"接口返回data数据异常：{res['data']}"

    @pytest.mark.release
    def test_donate_positive_updateRemark_ok(self):
        """更新支出记录的备注、详情URL和分类-正向用例"""
        res = self.donate.updateRemark(self.authorization)
        assert isinstance(res, dict), f'接口返回类型异常: {type(res)}'
        assert res['code'] == 200, f"接口返回状态码异常: 预期【200】，实际【{res['code']}】"
        assert res['message'] == 'success', f"接口返回message信息异常: 预期【success】，实际【{res['message']}】"
    ...
    def test_donate_permission_updateRemark(self, desc, value):
        ...
        # 鉴权作为位置参数直接传入（示例期望的极简风格）
        res = self.donate.updateRemark(value)
        if res:
            assert isinstance(res, dict), f'接口返回类型异常: {type(res)}'
            assert res['code'] == 200, f"接口返回状态码异常: 预期【200】，实际【{res['code']}】"
            assert res['message'] == 'success', f"接口返回message信息异常: 预期【success】，实际【{res['message']}】"
    ...
    def test_donate_boundary_updateRemark_category(self):
        ...
        category = "test2"
        res = self.donate.updateRemark(self.authorization, category=category)
        assert isinstance(res, dict), f'接口返回类型异常: {type(res)}'
        assert res['code'] == 200, f"接口返回状态码异常: 预期【200】，实际【{res['code']}】"
        assert res['message'] == 'success', f"接口返回message信息异常: 预期【success】，实际【{res['message']}】"
        assert res['data'] == "支出记录已更新", f"接口返回data数据异常：{res['data']}"
    ...
    def test_donate_boundary_updateRemark_detailUrl(self):
        ...
        res = self.donate.updateRemark(self.authorization, category=detailUrl)
        assert isinstance(res, dict), f'接口返回类型异常: {type(res)}'
        assert res['code'] == 200, f"接口返回状态码异常: 预期【200】，实际【{res['code']}】"
        assert res['message'] == 'success', f"接口返回message信息异常: 预期【success】，实际【{res['message']}】"
        assert res['data'] == "支出记录已更新", f"接口返回data数据异常：{res['data']}"
    ...
    def test_donate_boundary_updateRemark_remark(self):
        """更新支出记录的备注、详情URL和分类-边界值测试(category)"""
        detailUrl = "remark1"
        res = self.donate.updateRemark(self.authorization, remark=detailUrl)
        assert isinstance(res, dict), f'接口返回类型异常: {type(res)}'
        assert res['code'] == 200, f"接口返回状态码异常: 预期【200】，实际【{res['code']}】"
        assert res['message'] == 'success', f"接口返回message信息异常: 预期【success】，实际【{res['message']}】"
        assert res['data'] == "支出记录已更新", f"接口返回data数据异常：{res['data']}"
    ...
    def test_donate_scenario_updateRemark_invalid_transactionId(self):
        ...
        res = self.donate.updateRemark(self.authorization, transactionId=transactionId)
        assert isinstance(res, dict), f'接口返回类型异常: {type(res)}'
