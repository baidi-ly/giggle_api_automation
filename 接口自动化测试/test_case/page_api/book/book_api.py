...
class BookApi(BaseAPI):
    ...
    def indexaudio_details(self, authorization, bookId=0, language='', DeviceType="web", code=200, **kwargs):
        """
        查询故事书首页语音
    ...
    def indexaudio_details1(self, authorization, bookId=0, language='', file=None, DeviceType="web", code=200, **kwargs):
        """
        上传并保存故事书首页语音
        :param bookId: (integer, path, required) 故事书ID
        :param language: (string, path, required) 语言代码
    ...
    def indexaudio_details2(self, authorization, bookId=0, language='', file=None, DeviceType="web", code=200, **kwargs):
        """
        上传并保存故事书首页语音
        :param bookId: (integer, path, required) 故事书ID
        :param language: (string, path, required) 语言代码
    ...
    def indexaudio_details3(self, authorization, bookId=0, language='', file=None, DeviceType="web", code=200, **kwargs):
        """
        上传并保存故事书首页语音
        :param bookId: (integer, path, required) 故事书ID
        :param language: (string, path, required) 语言代码
    ...
    def indexaudio_details4(self, authorization, bookId=0, language='', file=None, DeviceType="web", code=200, **kwargs):
        """
        上传并保存故事书首页语音
        :param bookId: (integer, path, required) 故事书ID
        :param language: (string, path, required) 语言代码
    ...
    def indexaudio_details5(self, authorization, bookId=0, language='', file=None, DeviceType="web", code=200, **kwargs):
        """
        上传并保存故事书首页语音
        :param bookId: (integer, path, required) 故事书ID
        :param language: (string, path, required) 语言代码
    ...
    def indexaudio_details6(self, authorization, bookId=0, language='', file=None, DeviceType="web", code=200, **kwargs):
        """
        上传并保存故事书首页语音
        :param bookId: (integer, path, required) 故事书ID
        :param language: (string, path, required) 语言代码
    ...
    def indexaudio_details7(self, authorization, bookId=123, language='zh', DeviceType="web", code=200, **kwargs):
        """
        获取书籍音频索引
        ...
        """
        # Create Data:  V1.19.0  &  2025-10-14
        url = f"https://{base_url}/book/{bookId}/indexAudio/{language}"
        timestamp = str(int(time.time() * 1000))
        headers = self.request_header(timestamp, authorization, DeviceType)
    ...
    def getBooks(self, authorization, page=1, size=10, language='en', DeviceType="web", code=200, **kwargs):
        """
        获取书籍列表
        :param page: (integer, query, optional) 页码
        :param size: (integer, query, optional) 每页大小
        :param language: (string, query, optional) 语言
        :return: 接口原始返回（已 json 解析）
        """
        # Create Data:  V1.19.0  &  2025-10-14
        url = f"https://{base_url}/books"
        payload = {
            "page": page,
            "size": size,
            "language": language
    ...
    def indexaudio_details8(self, authorization, bookId=123, language='zh', DeviceType="web", code=200, **kwargs):
        """
        获取书籍音频索引
        :param bookId: (integer, path, required) 书籍ID
        :param language: (string, path, required) 语言代码
    ...
    def indexaudio_details9(self, authorization, bookId=0, language='zh', file=None, DeviceType="web", code=200, **kwargs):
        """
        上传并保存故事书首页语音
        :param bookId: (integer, path, required) 故事书ID
        :param language: (string, path, required) 语言代码
