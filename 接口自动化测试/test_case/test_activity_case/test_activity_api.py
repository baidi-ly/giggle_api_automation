...
class TestActivity:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ('special_chars', '!@#$%^&*()', 500),
            ('email_format', 'test@example.com', 500),
            ('phone_format', '13800138000', 500),
            ('date_format', '2023-12-25', 500),
            ('emoji', '😀🎉🚀', 500),
            ('long_string', '', 500),
            ('unicode', '中文测试', 500),
            ('json_string', '{"key": "value"}', 500),
            ('xml_string', '<root><item>test</item></root>', 500),
            ('url_string', 'https://www.example.com', 500),
            ('base64_string', 'SGVsbG8gV29ybGQ=', 500),
        ]
    )
