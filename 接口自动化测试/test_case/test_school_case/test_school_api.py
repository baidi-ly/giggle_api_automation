...
class TestSchoolApi:
    ...
    def test_school_format_putAuto1_studentId(self, desc, value):
        """更新学生信息-数据格式测试(studentId)"""
    ...
    def test_school_format_deleteAuto1_studentId(self, desc, value):
        """删除学生-数据格式测试(studentId)"""
